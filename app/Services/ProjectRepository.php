...
class ProjectRepository
{
    ...
    public function getPageHtml(Project $project, string $name = 'index'): string {
    ...
    private function addBootstrapFiles($projectPath)
    {
        ...
        File::copyDirectory(
            ...
            public_path("builder/projects/$projectPath/font-awesome"),
        );

        // bootstrap
        File::copyDirectory(
            public_path('builder/bootstrap'),
            public_path("builder/projects/$projectPath/bootstrap"),
        );
    }
